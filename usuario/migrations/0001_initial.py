...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('usuario_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='usuario.Usuario')),
                ('tipo', models.CharField(choices=[('PA', 'Pai'), ('MA', 'Mãe'), ('RL', 'Responsável Legal')], max_length=2, verbose_name='Tipos Responsável')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='atendido',
            name='responsaveis',
            field=models.ManyToManyField(to='usuario.Responsavel', verbose_name='Responsáveis'),
        ),
    ]
